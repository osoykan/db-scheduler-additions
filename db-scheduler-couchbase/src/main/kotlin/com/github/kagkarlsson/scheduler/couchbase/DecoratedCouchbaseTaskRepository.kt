...
class DecoratedCouchbaseTaskRepository(
  private val taskRepository: SuspendedCouchbaseTaskRepository,
  private val scope: CoroutineScope
) : TaskRepository {
  private val logger = LoggerFactory.getLogger(DecoratedCouchbaseTaskRepository::class.java)
