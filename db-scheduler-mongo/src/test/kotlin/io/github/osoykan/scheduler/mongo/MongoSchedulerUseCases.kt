...
class MongoSchedulerUseCases : SchedulerUseCases<Mongo>() {
  ...
  override suspend fun beforeSpec(spec: Spec) {
    ...
    println("MongoDB URL: ${mongoContainer.replicaSetUrl}")
  ...
  override suspend fun caseDefinition(): CaseDefinition<Mongo> = CaseDefinition(mongo) { db, tasks, startupTasks, name ->
    MongoScheduler.create(db, tasks, startupTasks, name)
  }
}
